...
<link href="/css/form/car.css" rel="stylesheet">
                              ...
                              <div class="input-area mb40">
                                    <div class="bottom-table border-table">
                                      ...
                                      <table summary="대여선택 정보">
                                            ...
                                            <tbody>
                                                <tr>
                                                  <th scope="row"><em class="mustIco">*</em> 대여시간</th>
                                                  <td><input type="text" name="" id="" title="" maxlength="18" style="width:100px;ime-mode:disabled;"/>
                                                  <select name="" id="" title="" style="width:80px;">
                                                        ...
                                                        <input type="text" name="" id="" title="" maxlength="18" style="width:100px;ime-mode:disabled;"/>
                                                  <select name="" id="" title="" style="width:80px;">
                                                            <option value="08시">08시</option>
                                                            <option value="09시">09시</option>
                                                            <option value="10시">10시</option>
