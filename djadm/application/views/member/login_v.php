		...
		<fieldset>
		    	...
		    	<div class="form-group">
			 	<label for="memberId" class="col-md-3 col-xs-1 control-label">아이디</label>
			    	<div class="col-md-7">
			      		<input type="text" class="form-control form_validate" id="memberId" name="m_id" value="<?php echo set_value('m_id'); ?>" alt="id">
			...
			<div class="form-group">
			 	<label for="memberPw" class="col-md-3 col-xs-1 control-label">비밀번호</label>
			    	<div class="col-md-7">
			      		<input type="password" class="form-control form_validate" id="memberPw" name="m_pw">
			      		<p class="help-block" id="memberPwError">&nbsp;</p>
			    	</div>
			</div>
			<div class="form-group">
			    	<div class="col-md-12 text-center">
			      		<button type="button" id="memberLogin" class="btn btn-primary btnFormSubmit">로그인</button>
			    	</div>
			</div>
		</fieldset>
	</form>
